...
def compute_feat_for_nnet_internal(wav: WaveData, lda: Matrix,
    ...
    Args:
        ...
        lda: A D1*D2 LDA transform matrix.
        **kwargs: See "options."

    Returns:
        feats: A T*D2 feature matrix.
    """
    options = {"is_use_energy": False, "is_downsample": True, "frame_shift": 5,
    ...
    # Apply LDA
    feats = feat.apply_lda_transform(feats, lda)
...
def compute_monophone_ppg(wav: WaveData, nnet: Nnet, lda: Matrix,
                          transform: SparseMatrix, shift=5) -> ndarray:
