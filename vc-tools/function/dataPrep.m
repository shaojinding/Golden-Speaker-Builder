...
%   - The aligner is in
%   '/var/gzhao/SpeechToolkitPSI/Montreal-Forced-Aligner-1.0.0'
%   - The PPG module is in '/var/gzhao/kaldi-posteriorgram'
...
function matList = dataPrep(wavList, transFile, outputDir, varargin)
    ...
    filePrefix = 'gsb';
    targetFs = 16000; % Hz
    aligner = '/var/gzhao/SpeechToolkitPSI/Montreal-Forced-Aligner-1.0.0/dist/montreal-forced-aligner/bin/mfa_align';
    dictionary = '/var/gzhao/SpeechToolkitPSI/Montreal-Forced-Aligner-1.0.0/dist/montreal-forced-aligner/pretrained_models/dictionary';
    acousticModel = '/var/gzhao/SpeechToolkitPSI/Montreal-Forced-Aligner-1.0.0/dist/montreal-forced-aligner/pretrained_models/english.zip';
    ppgExtractor = '/var/gzhao/kaldi-posteriorgram/run.sh';
    % Parse input
    p = inputParser;
