function [n2sgram,nsgram]=straightBodyC03ma(x,fs,tw,shiftm,fftl,f0raw,f0var,f0varL,eta,pc,imgi)
...
%   tw      : frame time window (ms) % 03/30/2016
...
%   03/30/2016 bug fix on hard coded time window, Guanlong Zhao

if nargin==10; imgi=1; end; % 10/Sept./2005, 03/30/2016
f0l=f0raw(:);
% framem=80; % 03/30/2016
framem=tw; % 03/30/2016
